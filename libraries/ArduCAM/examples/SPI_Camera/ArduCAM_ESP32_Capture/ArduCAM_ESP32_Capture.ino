  ...
  // 2. if server receives "ip address/capture",it can take photo and send to the Web.
  // 3.if server receives "ip address/stream",it can take photo continuously as video 
