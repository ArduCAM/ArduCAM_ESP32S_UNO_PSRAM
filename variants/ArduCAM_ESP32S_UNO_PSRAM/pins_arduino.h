...
static const uint8_t SDA = 18;//21
static const uint8_t SCL = 21;//22

static const uint8_t SS    = 0 ;//22;//5;
static const uint8_t MOSI  = 23;//23;
static const uint8_t MISO  = 19;//25;
static const uint8_t SCK   = 18;//19;
